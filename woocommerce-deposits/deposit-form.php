...
<div class="wc-deposits-wrapper <?php echo WC_Deposits_Product_Manager::deposits_forced( $post->ID ) ? 'wc-deposits-forced' : 'wc-deposits-optional'; ?>">
	...
	<?php else : ?>
		<div class="wc-deposits-payment-description" <?php echo $style; ?>>
			...
			Your standard down payment of $75.00 is non-refundable. It reserves time with me and gives you access to my pre-session workshops. Your payment will be applied to the final payment due at the start of our session.
		</div>
	<?php endif; ?>
</div>
